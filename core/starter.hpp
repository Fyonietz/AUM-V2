...
struct Config{
    ...
    inline static std::string db_type;
    inline static std::string mysql_host;
    inline static std::string mysql_user;
    inline static std::string mysql_password;
    inline static std::string mysql_database;
    inline static std::string mysql_port;
